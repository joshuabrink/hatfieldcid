          ...
          if(this.type == 'groups') {
            ...
            let changedContacts = 
                  updatedGroup.contacts.map(x => {
                     if(!req.body.contacts.includes(x)) {
                       return {
                         value: x,
                         query: false
                       }
                   ...
                   .concat(
                    ...
                    if(!updatedGroup.contacts.includes(x)) {
                      return {
                        value: x,
                        query: true
                      }
          ...
          Promise.resolve(promise).then((cList) => {
            ...
            this.collection
              ...
              .then(async (m) => {
                ...
                let allNumbers = contacts.map(c=>{return c.number.replace(/^0/g, '27')}).concat(cList.flat(1)).filter((c, index) => {
